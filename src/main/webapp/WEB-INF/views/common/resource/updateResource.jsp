  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	      ...
	      <div class="modal-footer">
		        ...
		        <shiro:hasPermission name="/common/resource/updateResources"><button type="button" class="btn btn-primary" onclick="updateResource()">保存</button></shiro:hasPermission>
	      </div>
    </div>
  </div>
</div>
