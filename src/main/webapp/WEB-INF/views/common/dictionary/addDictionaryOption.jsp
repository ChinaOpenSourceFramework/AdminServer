	      ...
	      <div class="modal-body">
	        	<form class="form-horizontal" id="dictionaryOption">
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="dictValue" name="dictValue" placeholder="资源" readonly="readonly" >
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="name" name="name" placeholder="选项名称" required >
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="value" name="value" placeholder="选项值" required>
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="sort" name="sort" placeholder="排序" required >
				    </div>
				  </div>
...
function addDictionaryOption(){
   var bootstrapValidator = $('#dictionaryOption').data('bootstrapValidator');
	...
	$.ajax({
		   type: "POST",
		   url: "common/dictionary/addDictionaryOption",
